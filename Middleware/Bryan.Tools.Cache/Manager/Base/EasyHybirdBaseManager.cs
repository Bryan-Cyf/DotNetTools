...
namespace Tools.Cache
{
    ...
    /// EasyCaching缓存服务
    /// </summary>
    public abstract class EasyHybirdBaseManager : IEasyCache
    {
        ...
        /// EasyCaching缓存提供器
        /// </summary>
        public IHybridCachingProvider Provider { get; set; }

        public EasyHybirdBaseManager(IHybridProviderFactory factory)
        {
            Provider = factory.GetHybridCachingProvider(Name);
        }
